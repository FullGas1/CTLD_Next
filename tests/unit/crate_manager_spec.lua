...
describe("CTLDCrate entity", function()
    ...
    describe("initial state (U-030)", function()
        ...
        it("isParachuting is false after new()", function()
            assert.is_false(makeCrate().isParachuting)
        end)
    ...
    describe("startParachute (U-030)", function()
        ...
        it("sets isParachuting to true", function()
            local c = makeCrate()
            c:startParachute(500)
            assert.is_true(c.isParachuting)
        end)
